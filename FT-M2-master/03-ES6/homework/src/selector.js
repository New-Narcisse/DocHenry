...
var matchFunctionMaker = function(selector) { // selector = ".myClass", "#id", "tag", "tag.class"
  ...
  if (selectorType === "id") { 
   matchFunction = function(el){ // el.id = myId === selector 
...
var $ = function(selector) { //".class", "#id", "tag", "tag.class"
  var elements;
  var selectorMatchFunc = matchFunctionMaker(selector); // funcion que recibe el elemento HTML y devuelve t / f
...
// selector = ".class", "#id", "tag", "tag.class"